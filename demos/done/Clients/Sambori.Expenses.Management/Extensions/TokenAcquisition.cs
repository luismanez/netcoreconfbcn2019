    ...
    public class TokenAcquisition : ITokenAcquisition
    {
        ...
        public async Task AddAccountToCacheFromAuthorizationCode(AuthorizationCodeReceivedContext context, IEnumerable<string> scopes)
        {
            ...
            try
            {
                ...
                Application = new ConfidentialClientApplication(_azureAdOptions.ClientId, _azureAdOptions.Authority, currentUri, credential, AuthPropertiesTokenCacheHelper.ForCodeRedemption(context.Properties), null);
        ...
        public async Task<string> GetAccessTokenOnBehalfOfUser(HttpContext context, ClaimsPrincipal user, string[] scopes)
        {
            ...
            var currentUri = UriHelper.BuildAbsolute(request.Scheme, request.Host, request.PathBase, request.Path);
            Application = new ConfidentialClientApplication(_azureAdOptions.ClientId, _azureAdOptions.Authority, currentUri, new ClientCredential(_azureAdOptions.ClientSecret), 
